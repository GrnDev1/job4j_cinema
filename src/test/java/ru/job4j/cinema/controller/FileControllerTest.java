...
class FileControllerTest {
    ...
    public void whenRequestGetByIdThenResponse200() throws Exception {
        ...
        when(fileService.findById(1)).thenReturn(fileDto);
    ...
    public void whenRequestGetByIdThenResponse404() {
        var expectedException = new NoSuchElementException("File with this id is not found");
        when(fileService.findById(1)).thenThrow(expectedException);
        var result = fileController.getById(1);
